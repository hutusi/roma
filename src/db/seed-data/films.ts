...
export const seedFilms: SeedFilm[] = [
  // ── Federico Fellini ──────────────────────────────────────────────
  {
    ...
    wikidataId: "Q12018",
    editorialNote:
      "费里尼开拍的时候，合同签了，档期定了，题材没有。他干脆把这个处境写成了剧本。片子里的圭多也是个导演，布景搭好了，剧本迟迟不来，记忆、欲望和负疚就趁虚而入。1963 年这么剪是新鲜的，如今看已经稀松平常：梦境、回忆、当下在一个镜头里换来换去，不作交代，也不提醒你。摄影上是让光来讲故事的。圭多的白衬衫，修女的黑袍，浴场蒸汽里过曝的一片，看的其实都是情绪。马斯楚安尼这个角色大半靠听戏完成，比看上去难演，也是全片能立住的原因。结尾那场马戏团式的圆圈舞，圭多算是跟「拍不出电影」这件事和解了，比他想要的那种和解小得多，不过大概也只能拿到这个。此后六十年，拍创作者自我怀疑的电影不少，诚实这一项上，好像也没往前走出多远。",
    editorialNoteEn:
  ...
  // ── Yasujirō Ozu ──────────────────────────────────────────────────
  {
    ...
    wikidataId: "Q26060",
    editorialNote:
      "平山老两口从尾道到东京看儿女，住了几天，被这家推到那家，最后是战死的儿子的遗孀纪子腾出时间陪他们。小津的机位放在跪坐的高度，很少移动，近景也少。全片没有争吵。怠慢的事一句都没点破，全在客客气气的对话里完成了，扎人也扎在这儿。母亲回乡后不久去世，父亲一个人留在空屋里，说了句今天又要热了。感情会随着距离和时间变薄，当事人往往要到来不及的时候才反应过来——影片的判断就藏在这些平淡里，没有拿出来说。纪子是唯一的例外，原节子演得很好。不过她的善意也不轻松，影片没打算替她解决这个问题。",
    editorialNoteEn:
  ...
  // first four here become the homepage 近期收录 strip.
  {
    ...
    wikidataId: "Q2995574",
    editorialNote:
      "戴家的院子被战火炸塌了一半，礼言病着，妻子玉纹每天上城墙走一趟，名义上是去买药。旧日情人章志忱以礼言同窗的身份登门，住下了。费穆的办法是把所有可能构成事件的时刻一个一个取消掉：没有出走，没有摊牌，唯一一次说明白的话被打断在半句上。人物讲话常常讲一半就停住，摄影机也基本不动，心理描写差不多全压在玉纹走城墙的那几组镜头上——还是那段路，走法不一样，得从步速和光线上自己看。全片只有五个人，戴秀的少女心事、老仆的沉默，各自都站得住，没有哪个角色是拿来推情节的。1948 年上映，正赶上时局大变，被批评回避现实，反响冷淡，此后几十年没怎么重映；八十年代重新流通之后，华语影史评选里就一直排在前面。这片子要安静着看。它大部分时间什么也不发生，能不能待得住，因人而异。",
    editorialNoteEn:
  ...
  },
  {
    ...
    wikidataId: "Q1056853",
    editorialNote:
      "苏丽珍和周慕云是邻居，两人的配偶正好搞在一起。他们想弄明白这种事到底是怎么开始的，就用排演的办法，互相扮演那两个人。排着排着，分寸就不好把握了。王家卫把承重的情节全拿掉了：偷情没拍，表白没说出口，那两位配偶的脸从头到尾不在画面里。剩下的是楼梯上的错身，走廊，慢镜里的烟，还有梅林茂那段来来回回的圆舞曲。张曼玉换了二十多件旗袍——具体多少件各处说法不一——反正颜色替她说了她不能说的话。结尾周慕云在吴哥窟对着石缝说了句什么，我们一个字也听不见。影片讲的是克制，但并不赞美克制。这两个人什么也没做，后半生就这么过去了。",
    editorialNoteEn:
      "Su Li-zhen and Chow Mo-wan are neighbours whose spouses are conducting an affair with each other. To work out how such a thing begins, they rehearse it, each playing the other's husband or wife, and the rehearsal stops being safe. Wong removed every load-bearing plot point: the adultery is not shown, the feeling is never declared, and the two unfaithful spouses never appear on camera. What is left is the near-misses on a staircase, the corridors, the smoke in slow motion, and Shigeru Umebayashi's waltz coming back and coming back. Maggie Cheung wears twenty-odd cheongsams — accounts differ on the exact number — and in any case the colours say what she is not allowed to say. At Angkor Wat, Chow murmurs something into a hollow in the stone and we hear none of it. The film is about restraint and it is not admiring of restraint. These two do nothing, and the rest of their lives goes by.",
    essay: doc([
      h2("克制作为一种纪律"),
      p(
  ...
  },
  {
    ...
    wikidataId: "Q2057159",
    editorialNote:
      "白天是母亲，夜里站街。吴永刚写这个本子的时候二十七岁，头一回当导演，处理得不太像那个年代的做法：不控诉，也不怜悯，机位跟人物平齐，连勒索她的那个流氓都只当环境的一部分拍，没弄成一个供人痛骂的反派。阮玲玉基本不靠字幕卡。她把攒下的钞票一张一张塞进墙砖缝里，这个动作已经把尊严说清楚了，多余的话一句也用不着加。中国默片大概就到这儿了。片子拍完的第二年，阮玲玉自杀，二十四岁。今天再看，站得住的还是影片对她的态度——把她当人拍。1934 年前后，愿意这么对待这种处境的女人的电影，我想不出还有第二部。",
    editorialNoteEn:
      "By day a mother, by night a streetwalker. Wu Yonggang wrote the script at twenty-seven. He was directing for the first time. His handling of the material was uncommon for 1934: no indictment, no pity, the camera set level with its subject. Even the gangster who extorts her is filmed as part of the environment, not staged as someone to hiss at. Ruan Lingyu works almost without intertitles. She pushes her saved banknotes one at a time into a gap in the brickwork, and the gesture has already explained what dignity means. Chinese silent film probably reached its ceiling here. Ruan killed herself the following year, at twenty-four. What holds up on a return visit is the film's posture toward its heroine — it films her as a person. Around 1934 I cannot think of much else anywhere that was willing to do the same for a woman in her position.",
    essay: doc([
      h2("平视的高度"),
      p(
