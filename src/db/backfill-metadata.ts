 ...
 * list. Dry-run by default; `--apply` writes in one transaction.
 *
 *   bun run src/db/backfill-metadata.ts [--films=a,b] [--apply]
 *   # prod: DATABASE_URL="$DATABASE_URL_UNPOOLED" bun run src/db/backfill-metadata.ts --apply
 *
