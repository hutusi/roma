    ...
    <div className="max-w-3xl">
      ...
      <div className="mt-8 space-y-8">
        ...
        <Section title="编辑札记（200–500 字）">
          <p>
            每部影片的核心是一段 200–500 字的编辑札记。字数按<strong>字符</strong>计（表单里有实时计数），
            不足 200 字或超过 500 字都无法发布。
          </p>
          <p>
        ...
        <Section title="图片与版权">
          <p>
            上传任何图片都<strong>必须填写来源（credit）</strong>——这不是形式，是版权风险的第一道防线。
            优先使用公有领域素材与 Wikimedia Commons；老电影（尤其 1950 年代以前）常有公版剧照。
          </p>
          <p>
        ...
        <Section title="片单：顺序即立场">
          <p>
            ...
            以及<strong>经过斟酌的先后顺序</strong>——顺序传达观看路径，是编辑立场的一部分，可拖动调整。
          </p>
          <p>
        ...
        <Section title="发布流程">
          <p>
            所有内容先存草稿，草稿对读者不可见（公开页直接 404）。用「预览」按读者视角检查——预览与公开页
